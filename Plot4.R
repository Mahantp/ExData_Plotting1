...
setwd("/Users/mpattan/Google Drive/RPrograms/ExData_Plotting1/")
...
unzip(file, exdir = "/Users/mpattan/Google Drive/RPrograms/ExData_Plotting1/")
# Creates the "household_power_consumption.txt" file!

data <- fread("household_power_consumption.txt", sep = ";", header = T, na.strings=c("?",""), stringsAsFactors = FALSE)
